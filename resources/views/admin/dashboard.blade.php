    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat red">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{ $total_news }}"></span>
                    </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat green">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value="{{ $total_order }}"></span>
                    </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="dashboard-stat purple">
                ...
                <div class="details">
                    ...
                    <div class="desc"> Tổng tiền(VND)</div>
                </div>
                {{--<a class="more" href="javascript:;"> View more--}}
                    {{--<i class="m-icon-swapright m-icon-white"></i>--}}
                {{--</a>--}}
